...
RTDebug::RTDebug(const RTDebug& other)
{
}
...
bool RTDebug::Initialize(ID3D11Device* device, int screenWidth, int screenHeight, int bitmapWidth, int bitmapHeight)
{
  bool result;
...
bool RTDebug::Render(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
  bool result;
...
int RTDebug::GetIndexCount()
{
  return m_indexCount;
}


bool RTDebug::InitializeBuffers(ID3D11Device* device)
{
  VertexType* vertices;
...
bool RTDebug::UpdateBuffers(ID3D11DeviceContext* deviceContext, int positionX, int positionY)
{
...
void RTDebug::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
  unsigned int stride;
  unsigned int offset;
