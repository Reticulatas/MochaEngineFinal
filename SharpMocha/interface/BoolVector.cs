...
public partial class BoolVector : global::System.IDisposable, global::System.Collections.IEnumerable
    , global::System.Collections.Generic.IList<bool>
 {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          SharpMochaPINVOKE.delete_BoolVector(swigCPtr);
        }
  ...
  public void Clear() {
    SharpMochaPINVOKE.BoolVector_Clear(swigCPtr);
  }

  public void Add(bool x) {
    SharpMochaPINVOKE.BoolVector_Add(swigCPtr, x);
  }

  private uint size() {
    uint ret = SharpMochaPINVOKE.BoolVector_size(swigCPtr);
    return ret;
  }

  private uint capacity() {
    uint ret = SharpMochaPINVOKE.BoolVector_capacity(swigCPtr);
    return ret;
  }

  private void reserve(uint n) {
    SharpMochaPINVOKE.BoolVector_reserve(swigCPtr, n);
  }

  public BoolVector() : this(SharpMochaPINVOKE.new_BoolVector__SWIG_0(), true) {
  }
  ...
  public BoolVector(int capacity) : this(SharpMochaPINVOKE.new_BoolVector__SWIG_2(capacity), true) {
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }

  private bool getitemcopy(int index) {
    bool ret = SharpMochaPINVOKE.BoolVector_getitemcopy(swigCPtr, index);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool getitem(int index) {
    bool ret = SharpMochaPINVOKE.BoolVector_getitem(swigCPtr, index);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, bool val) {
    SharpMochaPINVOKE.BoolVector_setitem(swigCPtr, index, val);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(BoolVector values) {
    SharpMochaPINVOKE.BoolVector_AddRange(swigCPtr, BoolVector.getCPtr(values));
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, bool x) {
    SharpMochaPINVOKE.BoolVector_Insert(swigCPtr, index, x);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, BoolVector values) {
    SharpMochaPINVOKE.BoolVector_InsertRange(swigCPtr, index, BoolVector.getCPtr(values));
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    SharpMochaPINVOKE.BoolVector_RemoveAt(swigCPtr, index);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    SharpMochaPINVOKE.BoolVector_RemoveRange(swigCPtr, index, count);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Reverse() {
    SharpMochaPINVOKE.BoolVector_Reverse__SWIG_0(swigCPtr);
  }

  public void Reverse(int index, int count) {
    SharpMochaPINVOKE.BoolVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (SharpMochaPINVOKE.SWIGPendingException.Pending) throw SharpMochaPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool Contains(bool value) {
    bool ret = SharpMochaPINVOKE.BoolVector_Contains(swigCPtr, value);
    return ret;
  }

  public int IndexOf(bool value) {
    int ret = SharpMochaPINVOKE.BoolVector_IndexOf(swigCPtr, value);
    return ret;
  }

  public int LastIndexOf(bool value) {
    int ret = SharpMochaPINVOKE.BoolVector_LastIndexOf(swigCPtr, value);
    return ret;
  }

  public bool Remove(bool value) {
    bool ret = SharpMochaPINVOKE.BoolVector_Remove(swigCPtr, value);
    return ret;
  }
