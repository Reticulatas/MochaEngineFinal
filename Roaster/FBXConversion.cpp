...
void Converter::Initialize(FbxScene* pScene)
{
  ...
  {
    //std::cout << "Converting from Max Coordinate System to DirectX\n";
  ...
  {	
    //std::cout << "Converting from Maya/OpenGL Coordinate System to DirectX\n";
    ConversionMatrix.SetRow( 0 , FbxVector4(1,0,0,0)  );
  ...
  {
    std::cout << "Unsupported Axis System, no conversion available\n";
  }
