...
public class PauseMenuSelector_Quit : MochaScript
{
	CTransform trans_;
	int item_;
	...
	public void OnStart()
	{
		...
		// No
		itemPos_.Insert(0,new Vector2(0.103f,-0.07f));
		// Yes
		itemPos_.Insert(0,new Vector2(0.103f,-0.063f));
	}

	public void OnUpdate()
	{
		float upVal = Math.Max(Input.GetTriggered(0,"up"),Input.GetTriggered(0,"arrowUp"));
		float downVal = Math.Max(Input.GetTriggered(0,"down"),Input.GetTriggered(0,"arrowDown"));
